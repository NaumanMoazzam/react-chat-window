...
var Message = function (_Component) {
  ...
  Message.prototype._renderMessageOfType = function _renderMessageOfType(type) {
    switch (type) {
      case 'text':
        return _react2.default.createElement(_TextMessage2.default, _extends({}, this.props.message, { launcherColor: this.props.launcherColor, author: this.props.message.author }));
      case 'emoji':
